...
if (isset($_POST["act"])) {
    ...
    switch ($act) {
        case "store":
            ...
            $jk = $_POST["txJK"];
            $id_dsn = md5($nama);
            $sql = "INSERT INTO tbDOSEN(nama, nip, notlp, email, jk, id_dsn) VALUES('$nama', '$nip', '$notlp', '$email', '$jk', '$id_dsn');";
        ...
        case "update":
            ...
            $jk = $_POST["txJK"];
            $id_dsn = $_POST["id_dsn"];
            $sql = "UPDATE tbDOSEN SET nama='$nama', nip='$nip', notlp='$notlp', email='$email', jk='$jk' WHERE id_dsn='$id_dsn';";
            $hasil = mysqli_query($cnn, $sql);
            if ($hasil) {
                $footer = "<script>
                        Swal.fire({
        ...
        case "destroy":
            $id_dsn = $_POST['id_dsn'];
            $sql = "DELETE FROM tbDOSEN WHERE id_dsn='$id_dsn';";
            $hasil = mysqli_query($cnn, $sql);
            if ($hasil) {
                $footer = "<script>
                        Swal.fire({
...
?>
        ...
        <body class="sb-nav-fixed">
            <nav class="sb-topnav navbar navbar-expand navbar-dark bg-dark">
                <!-- Navbar Brand-->
                <a class="navbar-brand ps-3" href="../dashboard.php">KAMPOES</a>
                <!-- Sidebar Toggle-->
                    ...
                    <nav class="sb-sidenav accordion sb-sidenav-dark" id="sidenavAccordion">
                        <div class="sb-sidenav-menu">
                            <div class="nav">
                                ...
                                <a class="nav-link mt-2" href="./datadsn.php">
